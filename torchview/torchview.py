...
def draw_graph(
    ...
    **kwargs: Any,
    ...
    forward_prop(
        ...
        model_mode, hide_module_functions, **kwargs
    )

    model_graph = ComputationGraph(
        visual_graph, input_nodes, show_shapes, hide_inner_tensors, roll, depth
    )
...
def forward_prop(
    ...
    **kwargs: Any,
    ...
    try:
        ...
        new_module_forward = module_forward_wrapper(hide_module_functions)
